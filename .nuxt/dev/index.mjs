...
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/local-server/dsoba-mobile-demo/node_modules/unstorage/drivers/fs.mjs';
import file_58_47_47_47C_58_47local_45server_47dsoba_45mobile_45demo_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js from 'file://C:/local-server/dsoba-mobile-demo/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js';
import { digest, hash as hash$1 } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/youch/build/index.js';
...
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/local-server/dsoba-mobile-demo/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/local-server/dsoba-mobile-demo/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/local-server/dsoba-mobile-demo","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/local-server/dsoba-mobile-demo/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', file_58_47_47_47C_58_47local_45server_47dsoba_45mobile_45demo_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"file:///C:/local-server/dsoba-mobile-demo/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"C:/local-server/dsoba-mobile-demo/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/local-server/dsoba-mobile-demo/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/local-server/dsoba-mobile-demo/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/local-server/dsoba-mobile-demo/.data/kv"}));
...
const rootDir = "C:/local-server/dsoba-mobile-demo";
...
const _SJG4yoCcKjtD9yJuPEQvMtsUfQiFwfaxn4_jkZ14VU = (nitroApp) => {
...
const plugins = [
  _SJG4yoCcKjtD9yJuPEQvMtsUfQiFwfaxn4_jkZ14VU,
...
const _dxghlt = eventHandler((event) => {
...
const _lazy_QjqGO4 = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _dxghlt, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_QjqGO4, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_QjqGO4, lazy: true, middleware: false, method: undefined }
];
